...
Route::middleware('auth')->group(function() {
    ...
    ***********************************/
    ...
    // // update agen
    // Route::post('form/kemaskini/{id}', [App\Http\Controllers\MaklumatAm\AgenController::class, 'update'])->name('agen.update');
    ...
    // // update syarikat
    // Route::post('form/kemaskini/{id}', [App\Http\Controllers\MaklumatAm\PembekalController::class, 'update'])->name('pembekal.update');
    ...
    // // create pengilang
    // Route::post('form/syarikat/create', [App\Http\Controllers\MaklumatAm\PengilangController::class, 'store'])->name('pengilang.create');
    // // update pengilang
    // Route::post('form/kemaskini/{id}', [App\Http\Controllers\MaklumatAm\PengilangController::class, 'update'])->name('pengilang.update');
    ...
    // // update penginvoisan
    // Route::post('form/kemaskini/{id}', [App\Http\Controllers\MaklumatAm\PenginvoisanController::class, 'update'])->name('penginvoisan.update');
