                        ...
                        <div>
                            <form method="POST" class="form-horizontal" role="form" action="{{ $jenis == 'new' ? route('pengilang.create') : route('pengilang.update',$pengilangs->id) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="pihak_ketiga_nama" name="pihak_ketiga_nama" class="form-control" placeholder="Nama pengilang" value="{{ old('pihak_ketiga_nama',isset($pengilangs->pihak_ketiga_nama)?$pengilangs->pihak_ketiga_nama:null)}}" {{ $tajuk == "Paparan" ? 'disabled' : '' }}>
                                ...
                                <div class="form-group row mt-0 mt-sm-2 mb-0 mb-sm-2">
                                    ...
                                    <div class="col-md-2 mb-2 mb-sm-0">
                                        <input type="number" id="pihak_ketiga_poskod" name="pihak_ketiga_poskod" class="form-control" placeholder="Poskod" value="{{ old('pihak_ketiga_poskod',isset($pengilangs->pihak_ketiga_poskod)?$pengilangs->pihak_ketiga_poskod:null) }}" {{ $tajuk == "Paparan" ? 'disabled' : '' }}>
                                        @error('pihak_ketiga_poskod') 
                                        <small class='text-danger'>{{ $message }}</small> 
                                        @enderror                                
                                    </div>
                                    <div class="col-md-3 mb-2 mb-sm-0">
                                        <input type="text" id="pihak_ketiga_bandar" name="pihak_ketiga_bandar" class="form-control" placeholder="Bandar" value="{{ old('pihak_ketiga_bandar',isset($pengilangs->pihak_ketiga_bandar)?$pengilangs->pihak_ketiga_bandar:null) }}" {{ $tajuk == "Paparan" ? 'disabled' : '' }}>
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control" name="pihak_ketiga_negeri" {{ $tajuk == "Paparan" ? 'disabled' : '' }}>
                                            ...
                                            <option value="Johor" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Johor" ? 'selected' : '' }}>Johor</option>
                                            <option value="Melaka" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Melaka" ? 'selected' : '' }}>Melaka</option>
                                            <option value="Negeri Sembilan" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Negeri Sembilan" ? 'selected' : '' }}>Negeri Sembilan</option>
                                            <option value="Selangor" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Selangor" ? 'selected' : '' }}>Selangor</option>
                                            <option value="Wilayah Persekutuan Putrajaya, Selangor" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Wilayah Persekutuan Putrajaya, Selangor" ? 'selected' : '' }}>Wilayah Persekutuan Putrajaya, Selangor</option>
                                            <option value="Wilayah Persekutuan Kuala Lumpur" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Wilayah Persekutuan Kuala Lumpur" ? 'selected' : '' }}>Wilayah Persekutuan Kuala Lumpur</option>
                                            <option value="Pahang" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Pahang" ? 'selected' : '' }}>Pahang</option>
                                            <option value="Terengganu" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Terengganu" ? 'selected' : '' }}>Terengganu</option>
                                            <option value="Kelantan" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Kelantan" ? 'selected' : '' }}>Kelantan</option>
                                            <option value="Perak" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Perak" ? 'selected' : '' }}>Perak</option>
                                            <option value="Kedah" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Kedah" ? 'selected' : '' }}>Kedah</option>
                                            <option value="Perlis" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Perlis" ? 'selected' : '' }}>Perlis</option>
                                            <option value="Pulau Pinang" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Pulau Pinang" ? 'selected' : '' }}>Pulau Pinang</option>
                                            <option value="Sabah" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Sabah" ? 'selected' : '' }}>Sabah</option>
                                            <option value="Sarawak" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Sarawak" ? 'selected' : '' }}>Sarawak</option>
                                            <option value="Wilayah Persekutuan Labuan, Sabah" {{ old('pihak_ketiga_negeri',isset($pengilangs->pihak_ketiga_negeri)?$pengilangs->pihak_ketiga_negeri:null) == "Wilayah Persekutuan Labuan, Sabah" ? 'selected' : '' }}>Wilayah Persekutuan Labuan, Sabah</option>
                                        </select>                                    
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" name="pihak_ketiga_negara" {{ $tajuk == "Paparan" ? 'disabled' : '' }}>
                                            ...
                                            @foreach($list_negara as $negara)
                                                <option value="{{ $negara->negara_nama }}" {{ old('pihak_ketiga_negara' , isset($pengilangs->pihak_ketiga_negara)?$pengilangs->pihak_ketiga_negara:null ) == $negara->negara_nama ? 'selected' : '' }} >{{ $negara->negara_nama }}</option>
                                            @endforeach
                                        </select>   
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="pihak_ketiga_no_faks" name="pihak_ketiga_no_faks" class="form-control" placeholder="Nombor faks" value="{{ old('pihak_ketiga_no_faks',isset($pengilangs->pihak_ketiga_no_faks)?$pengilangs->pihak_ketiga_no_faks:null) }}" {{ $tajuk == "Paparan" ? 'disabled' : '' }}>
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-8 offset-3">
                                        ...
                                        @endif
                                        <button type="button" onclick="window.location='{{ route('main.pengilang') }}'" name="pihak_ketiga_batal" id="pihak_ketiga_batal" class="btn btn-light waves-effect">
