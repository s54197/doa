                    ...
                    <div class="col-12">
                        <div>
                            <form method="POST" class="form-horizontal" role="form" action="{{ $jenis == 'new' ? route('penginvoisan.create') : route('penginvoisan.update',$penginvoisans->id) }}">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label" for="penginvoisan_no_faks"><span class="text-danger">*</span>Nombor faks:</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-8 offset-3">
                                        ...
                                        <button type="reset" name="penginvoisan_batal" id="penginvoisan_batal" class="btn btn-light waves-effect">Kosongkan</button>
                                        @endif
