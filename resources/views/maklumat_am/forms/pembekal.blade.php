                            ...
                            <form method="POST" class="form-horizontal" role="form" action="{{ $jenis == 'new' ? route('pembekal.create') : route('pembekal.update',$pembekals->id) }}">
                                ...
                                <div class="form-group row mt-0 mt-sm-2 mb-0 mb-sm-2">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control" name="pembekal_negeri" {{ $tajuk == "Paparan" ? 'disabled' : '' }}>
                                            ...
                                            <option value="Johor" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Johor" ? 'selected' : '' }}>Johor</option>
                                            <option value="Melaka" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Melaka" ? 'selected' : '' }}>Melaka</option>
                                            <option value="Negeri Sembilan" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Negeri Sembilan" ? 'selected' : '' }}>Negeri Sembilan</option>
                                            <option value="Selangor" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Selangor" ? 'selected' : '' }}>Selangor</option>
                                            <option value="Wilayah Persekutuan Putrajaya, Selangor" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Wilayah Persekutuan Putrajaya, Selangor" ? 'selected' : '' }}>Wilayah Persekutuan Putrajaya, Selangor</option>
                                            <option value="Wilayah Persekutuan Kuala Lumpur" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Wilayah Persekutuan Kuala Lumpur" ? 'selected' : '' }}>Wilayah Persekutuan Kuala Lumpur</option>
                                            <option value="Pahang" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Pahang" ? 'selected' : '' }}>Pahang</option>
                                            <option value="Terengganu" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Terengganu" ? 'selected' : '' }}>Terengganu</option>
                                            <option value="Kelantan" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Kelantan" ? 'selected' : '' }}>Kelantan</option>
                                            <option value="Perak" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Perak" ? 'selected' : '' }}>Perak</option>
                                            <option value="Kedah" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Kedah" ? 'selected' : '' }}>Kedah</option>
                                            <option value="Perlis" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Perlis" ? 'selected' : '' }}>Perlis</option>
                                            <option value="Pulau Pinang" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Pulau Pinang" ? 'selected' : '' }}>Pulau Pinang</option>
                                            <option value="Sabah" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Sabah" ? 'selected' : '' }}>Sabah</option>
                                            <option value="Sarawak" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Sarawak" ? 'selected' : '' }}>Sarawak</option>
                                            <option value="Wilayah Persekutuan Labuan, Sabah" {{ old('pembekal_negeri',isset($pembekals->pembekal_negeri)?$pembekals->pembekal_negeri:null) == "Wilayah Persekutuan Labuan, Sabah" ? 'selected' : '' }}>Wilayah Persekutuan Labuan, Sabah</option>
                                        </select>                                    
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-8 offset-3">
                                        ...
                                        <button type="reset" name="pembekal_batal" id="pembekal_batal" class="btn btn-light waves-effect">Kosongkan</button>
                                        @endif
