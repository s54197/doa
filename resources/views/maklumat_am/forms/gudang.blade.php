                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" name="gudang_negara" {{ $tajuk == "Paparan" ? 'disabled' : '' }}>
                                            ...
                                            @foreach($list_negara as $negara)
                                                <option value=" {{ $negara->negara_nama }}" {{ old('gudang_negara' , isset($gudangs->gudang_negara)?$gudangs->gudang_negara:null ) == $gudangs->gudang_negara ? 'selected' : '' }} >{{ $negara->negara_nama }}</option>
                                            @endforeach
                                        </select>   
                                        @error('gudang_negara') 
                                        <small class='text-danger'>{{ $message }}</small> 
